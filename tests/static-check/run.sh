...
function create_image() {
  ...
  buildah run $c -- dnf -q -y install autoconf-archive pcre-devel pcre2-devel openssl-devel libxml2-devel pam-devel lmdb-devel libacl-devel libyaml-devel curl-devel libvirt-devel librsync-devel >/dev/null 2>&1
